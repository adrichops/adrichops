---
id: knife-maintenance-daily-routine
title: 'Knife maintenance: the daily routine that prevents sad orange freckles'
type: Maintenance
...
maker: Adrichops
steel: Maintenance
length: Daily routine
bestFor: Longer edge life
rating: N/A
verdict: Care routine
summary: A simple care routine for stainless, carbon, wood handles and the board you
  probably underthink.
deck: 'Knife maintenance is mostly washing, drying, storing and not doing cursed things.
  Good news: very achievable.'
heroImage: assets/img/maintenance-routine.svg
heroAlt: Maintenance routine
pullQuote: Most knife care is boring. Boring is how the knife stays good.
specs:
  Daily rule: Wash and dry immediately
  Board rule: No glass or marble
  Storage rule: Separate edges
  Sharpening rule: Maintain before miserable
takeaways:
...
- src: assets/img/boards-storage.svg
  alt: Boards and storage
  caption: Cutting board, blade guard and magnetic storage shapes.
