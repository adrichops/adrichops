...
summary: 'A focused brief on King stones for kitchen knives: why the 1000 and combo
  stones are beginner classics, and where they demand maintenance.'
deck: King stones are not glamorous. They are affordable, readable and willing to
  show you what your hands are doing wrong.
...
- name: King Deluxe 1000 whetstone
  merchant: Amazon UK
  category: Sharpening
  note: Classic medium-grit learner stone. Good feedback, sensible price, real sharpening
    ability.
...
- name: King 1000/6000 combination whetstone
  merchant: Amazon UK
  category: Sharpening
  note: Popular combo direction for beginners who want sharpening and refinement in
    one block.
...
- name: King Deluxe - Matsunaga Stone
  ...
  type: Maker
  note: Official King Deluxe category with multiple medium and finishing grits for
...
- name: King Deluxe 1000 - Japanese Taste
  ...
  type: Retailer
  note: Retailer description of King Deluxe 1000 as a popular medium-grit stone for
    everyday sharpening.
...
- name: Japanese whetstones - Japanese Taste
  ...
  type: Retailer
  note: Retailer page listing Matsunaga King stones alongside Shapton and other Japanese
    sharpening brands.
