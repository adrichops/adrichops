---
id: how-steel-is-made-ore-scrap-fire-chemistry
title: 'How steel is made: ore, scrap, fire, chemistry, and why your knife cares'
type: Steel guide
category: culture
date: '2026-06-24'
readTime: 8 min read
featured: false
maker: Adrichops
steel: Steelmaking basics
length: Beginner friendly
bestFor: Understanding steel before buying
rating: N/A
verdict: Steel starts industrial; performance ends personal.
summary: A friendly map of how steel moves from ore or scrap into controlled blade
  material, and why heat treatment and grind still matter more than mythology.
deck: Steel is not fairy dust. It is iron, carbon, alloying, heat, cleanliness, and
  a lot of boring control. The boring part is why the knife works.
heroImage: assets/img/steel-making-route.svg
heroAlt: Minimal diagram of ore, furnace, steel bar and kitchen knife
pullQuote: A steel name tells you the recipe. It does not tell you whether the cook
  followed it.
specs:
  Format: Steelmaking primer
  Main routes: Blast furnace/basic oxygen and electric arc furnace
  Knife relevance: Chemistry, heat treatment, cleanliness, geometry
  Avoid: Treating steel names as magic words
takeaways:
- Steel is iron plus controlled carbon, alloying, cleanliness and heat treatment.
- Modern steel mainly comes through blast furnace/basic oxygen or electric arc furnace
  routes.
- For knives, heat treatment and grind can matter as much as the steel name.
products:
- name: Shapton Pro / Kuromaku 1000 grit stone
  merchant: Amazon UK
  category: Sharpening
  note: A practical medium stone for most stainless and carbon kitchen knives. Splash,
    sharpen, dry, move on with your life.
...
- name: Large soft cutting board
  merchant: Amazon UK
  category: Board
  note: Better edge life starts with not cutting on glass, stone, bamboo punishment
    blocks or vibes.
  url: https://www.amazon.co.uk/s?k=large+soft+cutting+board+kitchen+knife&tag=YOURTAG-21
  cta: Check current price
gallery:
- src: assets/img/steel-matrix.svg
  alt: Steel trade-off matrix
  caption: The recipe matters. The heat treatment and geometry decide how that recipe
    lands on the board.
sourceTrail:
- name: 'World Steel Association: raw materials'
  type: Steelmaking
  url: https://worldsteel.org/about-steel/raw-materials/
  note: Used for the two main steelmaking routes and raw material inputs.
- name: 'World Steel Association: overview of the steelmaking process'
  type: Steelmaking
  url: https://worldsteel.org/media/publications/overview-of-the-steelmaking-process/
  note: Used for process flow from raw materials through furnace routes, casting and
    applications.
- name: 'Eurofer: what is steel and how is steel made?'
  type: Steelmaking
  url: https://www.eurofer.eu/about-steel/learn-about-steel/what-is-steel-and-how-is-steel-made
  note: Used as a plain-language check on BF-BOF and EAF explanations.
- name: 'Knife Steel Nerds: steels rated by a metallurgist'
  type: Metallurgy
  url: https://knifesteelnerds.com/2021/10/19/knife-steels-rated-by-a-metallurgist-toughness-edge-retention-and-corrosion-resistance/
  note: Used for knife-specific trade-offs between edge retention, toughness, corrosion
