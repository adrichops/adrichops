...
summary: A practical guide to Hasegawa, Asahi and hinoki boards for Japanese knives,
  Amazon hunting and everyday maintenance.
deck: The board is not background furniture. It is the thing your edge hits hundreds
  of times per meal, so choose one that suits your knife and your habits.
heroImage: assets/img/boards-hasegawa-asahi-hinoki.svg
heroAlt: Minimal cutting board material guide illustration
pullQuote: A good board does not make a bad edge good, but a bad board can make a
  good edge miserable very quickly.
specs:
...
- Hasegawa suits push cutting and slicing; very soft boards can feel grippy under
  heavy rocking.
- Avoid glass, stone, marble and hard bamboo boards with thin Japanese edges.
- Buy enough board size for your main knife, not the smallest premium rectangle you
  can afford.
products:
...
- name: Hasegawa Kitchen Wares cutting boards
  ...
  type: Maker
  note: 'Official line overview: wood-core boards, soft surfaces for delicate Japanese
    knives, harder surfaces for general use.'
- name: Hasegawa Pro-Soft
  url: https://hasegawakagaku.com/products/pro-soft/
  type: Maker
  note: Official description of the soft wood-core board as blade friendly and suitable
    for sushi and sashimi cutting.
- name: Parker Asahi Cookin Cut rubber board PDF
  url: https://www.parker-asahi.co.jp/pdf/Elastic_Rubber_Chop_Board_en.pdf
  type: Maker
  note: Official material notes on synthetic rubber texture, low water absorption,
    quick drying and sanitation claims.
- name: Asahi vs Hasegawa boards - Kitchen Knife Forums
  ...
  type: Forum
  note: Forum comparison notes on grip, edge friendliness, push cutting and protein
    prep feel.
- name: Kai Shun Large Hinoki Cutting Board
  url: https://shun.kaiusa.com/large-hinoki-cutting-board.html
  type: Maker
  note: Retailer/manufacturer note describing hinoki as medium-soft wood that gives
    under the knife.
- name: Hinoki cutting board use guide
  url: https://hinoki-manaita.com/en/use.html
  type: Care reference
  note: Use guidance on wetting the board lightly before cutting, using both sides
    and washing during raw food prep.
status: Guide
tags:
- maintenance
---
