---
id: vg10-ginsan-aogami-shirogami-guide
title: 'VG10, Ginsan, Aogami, Shirogami: common Japanese steels without the fog machine'
type: Guide
category: guide
date: '2026-06-23'
readTime: 7 min read
featured: false
maker: Adrichops
steel: Japanese steels
length: Beginner map
bestFor: Reading listings
rating: N/A
verdict: Know the maintenance tax
summary: A practical guide to common Japanese knife steels and what they mean for
  maintenance, sharpening and everyday prep.
deck: The steel names are not spells. They are maintenance and performance clues.
  Useful clues, but still clues.
heroImage: assets/img/steel-types.svg
heroAlt: Common Japanese steel types
pullQuote: If the steel name does not change how you use or maintain the knife, it
  is just decoration.
specs:
  Format: Steel guide
  Steels: VG10, Ginsan, Aogami, Shirogami
  Best for: Beginner buying
  Warning: Maker and grind still matter
takeaways:
...
- name: Camellia oil for carbon steel
  ...
  note: Optional storage oil for reactive carbon blades. Wash and dry first; oil is
    not a permission slip for damp drawers.
...
- src: assets/img/steel-matrix.svg
  alt: Steel matrix
  caption: Steel choice is a triangle of edge, toughness and maintenance.
sourceTrail:
- name: 'Knife Steel Nerds: VG10 and SG2'
  type: Metallurgy
  url: https://knifesteelnerds.com/2019/12/16/vg10-and-super-gold-2-takefu-stainless-steel-properties-and-history/
  note: Used for VG10 and SG2 history, alloy context and practical caveats.
