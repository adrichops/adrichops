...
summary: 'A clear guide to the people and businesses behind a Japanese knife: blacksmiths,
  grinders, sharpeners, handle makers, brands and retailers.'
deck: The name on the blade is often not the whole story. This guide explains the
  chain without turning it into homework soup.
heroImage: assets/img/maker-chain.svg
heroAlt: Japanese knife maker chain diagram
pullQuote: 'The most honest answer to who made this knife is often: several skilled
  people, plus a brand that organized the chaos.'
specs:
  Format: Craft guide
  Focus: Maker roles
...
- src: assets/img/craft-map.svg
  alt: Craft map
  caption: Smith, sharpener, handle maker, brand and retailer all influence the final
    knife.
sourceTrail:
