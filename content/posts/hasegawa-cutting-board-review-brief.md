...
summary: 'A focused brief on Hasegawa soft cutting boards: why knife people like them,
  where they feel odd, and how to avoid buying the wrong one.'
deck: Hasegawa is the board recommendation that sounds expensive until you remember
  what a chipped Japanese edge costs in time, money and vocabulary.
heroImage: assets/img/hasegawa-board.svg
heroAlt: Minimal Hasegawa board illustration
pullQuote: Hasegawa is not magic. It is a soft landing zone for a good edge and a
  lie detector for rough technique.
specs:
...
- name: Hasegawa Pro-Soft
  ...
  type: Maker
  note: 'Official Pro-Soft explanation: wood-core structure, cushioning surface and
    Japanese-knife suitability.'
- name: Soft Cutting Board - Hasegawa Boards
  url: https://hasegawaboards.com/softcuttingboard.html
  type: Maker
  note: Additional Hasegawa detail on the sterilized wood core fully covered by plastic
    layers.
...
- name: Hasegawa boards explainer - Knifewear
  ...
  note: Retailer breakdown of Hasegawa lines, wood core and edge-friendly surface
    feel.
