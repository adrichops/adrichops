...
rating: N/A
verdict: Start here
summary: 'A practical map of the knife profiles that actually earn drawer space: chef
  knife, gyuto, santoku, nakiri, petty, paring, bread knife and the specialists.'
deck: Start with jobs, not brand names. Shape, size, steel and maintenance tolerance
  matter more than the romance printed on the box.
heroImage: assets/img/profiles-map.svg
heroAlt: Knife profiles
pullQuote: A knife profile is a job description. If the job is vague, the purchase
  usually is too.
specs:
...
- For low-fuss vegetables, a stainless santoku or nakiri is often more useful than
  a prestige chef knife.
