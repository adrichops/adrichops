...
summary: 'A friendly but honest brief on hinoki cutting boards: why they feel so good
  under Japanese knives and why they need real drying discipline.'
deck: Hinoki is the board for people who want cutting feel, smell and ritual. It is
  also the board for people who own a towel and know where sunlight comes from.
heroImage: assets/img/hinoki-board.svg
heroAlt: Minimal hinoki board illustration
pullQuote: Hinoki is charming because it is wood, and annoying for exactly the same
  reason.
specs:
...
- name: Kai Shun Large Hinoki Cutting Board
  ...
  type: Maker
  note: Manufacturer description of hinoki as medium-soft Japanese cypress that gives
    under the knife.
- name: Kai Shun Small Hinoki Cutting Board
  url: https://shun.kaiusa.com/small-hinoki-cutting-board.html
  type: Maker
  note: 'Use and care summary: wet before each use, wash with mild detergent, towel
    dry and air dry out of sunlight.'
- name: Hinoki cutting board use guide
  url: https://hinoki-manaita.com/en/use.html
  type: Care reference
  note: Practical use notes on wetting both sides, wiping excess water and using separate
    sides.
- name: Hinoki board care - Bernal Cutlery
  url: https://bernalcutlery.com/pages/hinoki-cutting-board-care
  type: Retailer care guide
  note: 'Care and technique notes: wet before use, avoid hacking, avoid aggressive
    serrations and twisting.'
- name: Hitohira Hinoki Endgrain Cutting Board - Karasu
  url: https://karasu-knives.com/products/aafea-106
  type: Retailer
  note: Specialist retailer listing for a Hitohira hinoki end-grain board, useful
    for sizing and context.
