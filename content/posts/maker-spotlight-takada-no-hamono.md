---
id: maker-spotlight-takada-no-hamono
title: 'Maker spotlight: Takada no Hamono, Sakai polish with gym membership'
type: Maker spotlight
category: culture
date: '2026-06-24'
readTime: 8 min read
featured: false
maker: Takada no Hamono
steel: 'Ginsan, Blue #1, White #2, VG10 and line-specific releases'
length: Mostly 210-270mm gyuto, santoku, nakiri, petty and slicers
bestFor: Thin convex cutting, refined prep and careful users
rating: N/A
verdict: Beautiful cutters, not beater knives
summary: An expanded guide to Mitsuaki Takada, the Sakai sharpener whose thin convex
  knives sit between performance tool and functional art.
deck: 'Takada no Hamono is where the knife internet gets quiet for a second: thin
  hamaguri-style geometry, immaculate polishing, scarce stock, and a very real question
  about whether you cook carefully enough to deserve it.'
heroImage: assets/img/maker-takada.svg
heroAlt: Minimal maker spotlight illustration for Takada no Hamono
pullQuote: A Takada is a thin, polished Sakai cutter. Treat it like a race bike, not
  a rental scooter.
specs:
  Region: Sakai, Osaka
  Known for: thin convex hamaguri-style grinding, Suiboku and refined finishes
...
takeaways:
- Do not buy Takada no Hamono by name alone; match the exact knife to food, board
  and care habits.
...
gallery: []
sourceTrail:
- name: TAKADA no HAMONO profile
  type: Manufacturer
  url: https://www.takadanohamono.com/profile.html
  note: Official profile of Mitsuaki Takada, his Sakai workshop and Ashi Hamono background.
- name: MTC Kitchen Takada no Hamono
  type: Retailer
  url: https://mtckitchen.com/collections/takada-no-hamono
  note: Retailer notes on Takada’s hamaguri convex edge and 2018 workshop founding.
- name: Bernal Cutlery Takada collection
  type: Retailer
  url: https://bernalcutlery.com/collections/takada-no-hamano
  note: Retailer context on Takada’s double-bevel convex grinding and cutting feel.
- name: Kitchen Knife Forums Takada tag
  type: Forum
  url: https://www.kitchenknifeforums.com/tags/takada/
  note: Forum context on ownership impressions, availability and line comparisons.
