...
summary: 'A focused brief on Shapton stones for kitchen knives: why the 1000 is so
  often recommended, how Glass and Kuromaku fit, and what to add next.'
deck: Shapton is the stone brand for the home cook who wants less soaking, less mud
  and fewer excuses between dull knife and sharp knife.
heroImage: assets/img/shapton-stones.svg
heroAlt: Minimal Shapton stone illustration
pullQuote: 'Shapton removes one beginner problem: waiting for the stone. Sadly, it
  does not remove the burr for you.'
specs:
...
- name: Shapton Kuromaku 1000 whetstone
  merchant: Amazon UK
  category: Sharpening
  note: The usual low-fuss first Shapton direction for kitchen knives. Check seller
    and exact grit before linking.
...
- name: Shapton stones - Classic Hand Tools
  ...
  type: Retailer
  note: 'Retailer notes on Shapton ceramic stones: slow-wearing, fast-cutting, no
    soaking needed.'
- name: Shapton Kuromaku 1000 - Cutlery and More
  url: https://cutleryandmore.com/products/shapton-kuromaku-stone-40434
  type: Retailer
  note: Retailer description of the Kuromaku Professional water stones as color-coded
    and splash-and-go.
- name: Beginner stone - King or Shapton Pro - Kitchen Knife Forums
  ...
  type: Forum
  note: Forum thread where Shapton 1000 is discussed as a low-maintenance single-stone
    choice.
