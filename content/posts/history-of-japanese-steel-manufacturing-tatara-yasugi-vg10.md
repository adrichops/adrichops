---
id: history-of-japanese-steel-manufacturing-tatara-yasugi-vg10
title: 'A short history of Japanese steel manufacturing: tatara, Yawata, Yasugi and
  VG10'
type: Steel history
category: culture
date: '2026-06-24'
...
featured: false
maker: Adrichops
steel: Japanese steel history
length: Beginner friendly
bestFor: Culture without mythology
rating: N/A
verdict: Respect the lineage; do not buy the fog machine.
summary: A practical timeline from iron-sand tatara steel through Meiji industrialisation
  to modern Yasugi and Takefu knife steels.
deck: Japanese steel history is not one clean samurai-to-gyuto montage. It is iron
  sand, furnaces, state industry, specialty steel, regional craft and a lot of polishing
  dust.
heroImage: assets/img/japanese-steel-history.svg
heroAlt: Minimal timeline from tatara furnace to modern Japanese knife steel
pullQuote: The useful version of history respects the craft without pretending every
  gyuto is a katana that learned to dice onions.
specs:
  Format: History guide
  Timeline: Tatara to Meiji industry to specialty cutlery steels
  Key places: Shimane, Yawata, Yasugi, Takefu, Sakai, Sanjo, Seki
  Avoid: Samurai smoke around ordinary product claims
takeaways:
- Tatara and tamahagane are central to Japanese blade culture, but most kitchen knives
  use modern industrial steels.
- Meiji industrialisation and Yawata Steel Works pushed Japan into modern integrated
  steelmaking.
- Yasugi and Takefu show how regional steel knowledge became modern knife materials
  such as Shirogami, Aogami, Ginsan and VG10.
products:
- name: Tojiro DP VG10 gyuto
  merchant: Amazon UK
  category: Knife
  note: A sensible way into modern Japanese stainless knife steel. Not mystical. Very
    useful. That is the point.
...
- name: Camellia oil for carbon knives
  ...
  note: For reactive carbon steels when storage or humidity asks for a little extra
    help.
  url: https://www.amazon.co.uk/s?k=camellia+oil+knife+care&tag=adrichops-21
  cta: Check current price
gallery:
- src: assets/img/steel-types.svg
  alt: Japanese steel types
  caption: 'Steel history gets more useful when it becomes behaviour: stainless, carbon,
    clad, reactive, forgiving, spicy.'
sourceTrail:
- name: 'Japan Travel: Shimane''s ancient Tatara ironworks'
  type: Craft history
  url: https://www.japan.travel/en/japans-local-treasures/shimanes-ancient-tatara-ironworks/
  note: Used for the connection between iron sand, charcoal, tatara and tamahagane.
- name: 'Wako Museum: Tatara ironmaking and tamahagane'
  type: Museum
  url: https://wako-museum.jp/entop/
  note: Used for regional ironworking context around clay tatara furnaces and high-grade
    tamahagane.
- name: 'Sites of Japan''s Meiji Industrial Revolution: Imperial Steel Works, Yawata'
  type: Industrial history
  url: https://www.japansmeijiindustrialrevolution.com/en/site/yawata/component01.html
  note: Used for the 1901 Yawata milestone and Japan's transition into integrated
    iron and steel production.
- name: 'Proterial: Yasugi Specialty Steel'
  type: Steelmaker
  url: https://www.proterial.com/e/yss/ourbrand.html
  note: Used for Yasugi Works, San'in iron-sand heritage and modern specialty-steel
    context.
- name: 'Takefu Special Steel: VG10'
  type: Steelmaker
  url: https://e-tokko.com/v_gold_10.php?lang=en
  note: Used for modern Japanese knife-steel context around VG10 and original laminated
    cutlery steels.
