...
summary: 'A practical grit progression for kitchen knives: what each stone does, when
  to stop and why more polish is not always better.'
deck: Most cooks need fewer stones and better habits. Sorry to the stone drawer. Actually,
  no, the stone drawer knows what it did.
heroImage: assets/img/grit-progression.svg
heroAlt: Grit progression
pullQuote: A 1000 grit edge that is fully deburred beats a 6000 grit edge that is
  lying.
specs:
  First grit: 800-1200
