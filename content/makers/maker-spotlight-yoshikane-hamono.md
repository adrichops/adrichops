---
id: maker-spotlight-yoshikane-hamono
title: 'Maker spotlight: Yoshikane Hamono, Sanjo workhorse manners with clean shoes'
...
steel: 'SKD semi-stainless and White #2 carbon are common favourites'
length: Gyuto, santoku, nakiri, bunka, petty, sujihiki and related profiles
bestFor: Sanjo convex performance and confident daily prep
rating: N/A
verdict: A benchmark Sanjo cutter
summary: 'Yoshikane is a practical reference point for Sanjo grinds: more structure than a laser, cleaner cutting than a thick Western chef knife.'
deck: 'Yoshikane explains why Sanjo has its own fanbase: spine, taper, convexity, food release and enough confidence to cut more than parsley for the camera.'
heroImage: assets/img/maker-yoshikane.svg
heroAlt: Minimal maker spotlight illustration for Yoshikane Hamono
pullQuote: Yoshikane feels like a grown-up workhorse that still knows how to dress for dinner.
specs:
  Region: Sanjo, Niigata
  Known for: 'convex Sanjo grinds, SKD and White #2, nashiji finishes'
...
gallery: []
sourceTrail:
- name: Yoshikane Hamono official site
  type: Manufacturer
  url: https://yoshikanehamonoknives.com/
  note: Yoshikane history, Sanjo location and 1919 founding context.
- name: Knives and Stones Yoshikane maker page
  type: Retailer
  url: https://www.knivesandstones.com.au/pages/maker/yoshikane-hamono
  note: 'Retailer notes on Sanjo grinds, White #2 and SKD.'
- name: Cutting Edge Knives Yoshikane
  type: Retailer
  url: https://cuttingedgeknives.co.uk/collections/yoshikane-hamono
  note: Retailer context on Shirogami, SKD and nashiji lines.
- name: Japanese Natural Stones Wakui Specials
  type: Retailer
  url: https://www.japanesenaturalstones.com/wakui-specials/
  note: Context for Yoshikane’s influence through Wakui’s apprenticeship.
status: Maker profile
sourceMode: Official maker or retailer context plus community consensus.
slug: maker-spotlight-yoshikane-hamono
route: /maker-spotlight/maker-spotlight-yoshikane-hamono/
---
