...
summary: A beginner-friendly guide to three major Japanese knife regions and why region labels help but never tell the full story.
deck: Sakai, Seki and Sanjo are useful map pins. They are not magic passwords. Here is how to read them without getting weird.
...
- name: 'Sakai Ichimonji: Knife making regions of Japan'
  ...
  note: Used for regional framing and the caveat that region labels need specific maker context.
...
slug: japanese-knife-regions-sakai-seki-sanjo
route: /guides/japanese-knife-regions-sakai-seki-sanjo/
---
