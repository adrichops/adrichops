...
summary: Honing rods and stones do different work. Use the rod lightly when it helps; use stones when steel must be removed.
deck: A honing rod is not a magic wand. A stone is not punishment. Use the right tool before the edge gets weird.
...
- name: 'Knife Steel Nerds: steels rated by a metallurgist'
  ...
  note: Used for trade-offs between toughness, edge retention, corrosion resistance and edge geometry.
status: Practical guide
sourceMode: Research-led guide with practical interpretation.
slug: honing-vs-sharpening-when-to-use-steel
route: /guides/honing-vs-sharpening-when-to-use-steel/
---
