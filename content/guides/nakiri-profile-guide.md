---
id: nakiri-profile-guide
title: 'Nakiri profile guide: the vegetable rectangle'
type: Guide
category: guide
date: '2026-06-20'
readTime: 6 min read
featured: false
maker: Adrichops
steel: Nakiri profile
length: 165 mm
bestFor: Vegetables
rating: N/A
verdict: Prep specialist
summary: A nakiri is a flat-edged vegetable knife, not a cleaver and not a chef knife replacement.
deck: 'The rectangular blade looks severe, but the job is calm: clean board contact, repeated cuts and easy vegetable transfer.'
heroImage: assets/img/nakiri-profile.svg
heroAlt: Nakiri profile
pullQuote: The nakiri makes vegetables feel orderly.
specs:
  Typical length: 160-180 mm
  Main job: Vegetable prep
  Technique: Straight push cuts and tap chopping
  Avoid: Bones, frozen food, twisting cuts
takeaways:
- Best for repeated vegetable prep.
- Do not use it as a cleaver.
- Thin geometry beats decorative hammered finishes.
products:
- name: Nakiri knife shortlist
  merchant: Amazon UK
  category: Knife
  note: Placeholder search link for vegetable knives. Replace with a specific model after you photograph and use it.
...
- name: Large soft cutting board
  ...
  note: A bigger, kinder board protects edges better than a small glass or marble surface.
...
slug: nakiri-profile-guide
route: /guides/nakiri-profile-guide/
---
