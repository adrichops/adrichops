...
summary: A friendly map of how steel moves from ore or scrap into controlled blade material, and why heat treatment and grind still matter more than mythology.
deck: Steel is not fairy dust. It is iron, carbon, alloying, heat, cleanliness, and a lot of boring control. The boring part is why the knife works.
heroImage: assets/img/steel-making-route.svg
heroAlt: Minimal diagram of ore, furnace, steel bar and kitchen knife
pullQuote: A steel name tells you the recipe. It does not tell you whether the cook followed it.
specs:
...
- src: assets/img/steel-matrix.svg
  ...
  caption: The recipe matters. The heat treatment and geometry decide how that recipe lands on the board.
sourceTrail:
...
- name: 'World Steel Association: overview of the steelmaking process'
  ...
  note: Used for process flow from raw materials through furnace routes, casting and applications.
...
- name: 'Knife Steel Nerds: steels rated by a metallurgist'
  ...
  note: Used for knife-specific trade-offs between edge retention, toughness, corrosion resistance and geometry.
status: Research guide
sourceMode: Research-led guide with practical interpretation.
slug: how-steel-is-made-ore-scrap-fire-chemistry
route: /guides/how-steel-is-made-ore-scrap-fire-chemistry/
---
