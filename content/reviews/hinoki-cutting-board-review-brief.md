---
id: hinoki-cutting-board-review-brief
title: 'Hinoki cutting boards: beautiful, soft, and only a little needy'
type: Review brief
category: maintenance
date: '2026-06-23'
readTime: 6 min read
featured: false
maker: Hinoki / Shun / Hitohira-style boards
steel: Japanese cypress
length: Varies by board
bestFor: Traditional cutting feel
rating: Research brief
verdict: Great if you accept wood care
summary: 'A friendly but honest brief on hinoki cutting boards: why they feel so good under Japanese knives and why they need real drying discipline.'
deck: Hinoki is the board for people who want cutting feel, smell and ritual. It is also the board for people who own a towel and know where sunlight comes from.
heroImage: assets/img/hinoki-board.svg
heroAlt: Minimal hinoki board illustration
pullQuote: Hinoki is charming because it is wood, and annoying for exactly the same reason.
specs:
  Material: Japanese cypress / hinoki
  Best fit: Japanese knives, careful prep, traditional feel
  Before use: Wet lightly and wipe excess water
  After use: Wash, towel dry, air dry away from direct sunlight
  Avoid: Dishwashers, soaking, hacking, aggressive serrations
takeaways:
...
products:
- name: Shun or Kai hinoki cutting board
  merchant: Amazon UK
  category: Board
  note: Common Amazon-searchable hinoki option. Confirm whether the listing is genuine and what size you are buying.
...
- name: Hitohira hinoki cutting board
  merchant: Amazon UK
  category: Board
  note: Specialist-retailer direction for serious hinoki boards. Use this search link as a placeholder only.
  url: https://www.amazon.co.uk/s?k=Hitohira+hinoki+cutting+board&tag=YOURTAG-21
  cta: Check current price
- name: Kamenoko tawashi scrub brush
  merchant: Amazon UK
  category: Care
  note: Traditional-style brush direction for gentle board cleaning. Avoid steel wool and harsh abrasives.
  url: https://www.amazon.co.uk/s?k=Kamenoko+tawashi+scrub+brush&tag=YOURTAG-21
  cta: Check current price
- name: Food-grade mineral oil
  merchant: Amazon UK
  category: Care
  note: Optional wood-care item depending on board guidance. Do not oil blindly if the maker says leave it untreated.
  url: https://www.amazon.co.uk/s?k=food+grade+mineral+oil+cutting+board&tag=YOURTAG-21
  cta: Check current price
gallery:
- src: assets/img/hinoki-board.svg
  alt: Hinoki board illustration
  caption: Soft wood feel, light ritual, careful drying.
sourceTrail:
- name: Kai Shun Large Hinoki Cutting Board
  url: https://shun.kaiusa.com/large-hinoki-cutting-board.html
  type: Maker
  note: Manufacturer description of hinoki as medium-soft Japanese cypress that gives under the knife.
- name: Kai Shun Small Hinoki Cutting Board
  url: https://shun.kaiusa.com/small-hinoki-cutting-board.html
  type: Maker
  note: 'Use and care summary: wet before each use, wash with mild detergent, towel dry and air dry out of sunlight.'
- name: Hinoki cutting board use guide
  url: https://hinoki-manaita.com/en/use.html
  type: Care reference
  note: Practical use notes on wetting both sides, wiping excess water and using separate sides.
- name: Hinoki board care - Bernal Cutlery
  url: https://bernalcutlery.com/pages/hinoki-cutting-board-care
  type: Retailer care guide
  note: 'Care and technique notes: wet before use, avoid hacking, avoid aggressive serrations and twisting.'
- name: Hitohira Hinoki Endgrain Cutting Board - Karasu
  url: https://karasu-knives.com/products/aafea-106
  type: Retailer
  note: Specialist retailer listing for a Hitohira hinoki end-grain board, useful for sizing and context.
status: Research brief
sourceMode: Manufacturer, retailer and community research; not a claimed hands-on test unless stated.
slug: hinoki-cutting-board-review-brief
route: /reviews/hinoki-cutting-board-review-brief/
---
