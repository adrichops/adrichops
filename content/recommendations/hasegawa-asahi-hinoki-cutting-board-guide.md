---
id: hasegawa-asahi-hinoki-cutting-board-guide
title: 'Hasegawa, Asahi and hinoki: cutting boards that do not hate your edge'
type: Guide
...
featured: false
maker: Adrichops
steel: Board materials
length: Home kitchen sizes
bestFor: Edge-friendly prep
rating: N/A
verdict: Buy the board for your cutting style
summary: A practical guide to Hasegawa, Asahi and hinoki boards for Japanese knives, Amazon hunting and everyday maintenance.
deck: The board is not background furniture. It is the thing your edge hits hundreds of times per meal, so choose one that suits your knife and your habits.
heroImage: assets/img/boards-hasegawa-asahi-hinoki.svg
heroAlt: Minimal cutting board material guide illustration
pullQuote: A good board does not make a bad edge good, but a bad board can make a good edge miserable very quickly.
specs:
  Boards covered: Hasegawa, Asahi rubber, hinoki cypress
  Best low-fuss pick: Asahi or Hasegawa synthetic board
  Best traditional feel: Hinoki
  Avoid: Glass, marble, stone counters and hard bamboo punishment slabs
  Care baseline: Hand wash, dry, store with air around both faces
takeaways:
...
products:
- name: Hasegawa soft cutting board
  merchant: Amazon UK
  category: Board
  note: Edge-friendly synthetic board with wood-core construction. Replace the search URL with a specific FSR, FRK or PE listing you trust.
...
- name: Asahi Cookin Cut rubber cutting board
  merchant: Amazon UK
  category: Board
  note: Synthetic rubber board direction for a low-fuss, knife-friendly prep surface. Check size and seller before linking directly.
  url: https://www.amazon.co.uk/s?k=Asahi+Cookin+Cut+rubber+cutting+board&tag=adrichops-21
  cta: Check current price
- name: Hinoki cutting board
  merchant: Amazon UK
  category: Board
  note: Traditional Japanese cypress option. Best for people who will wet before use and dry properly after washing.
  url: https://www.amazon.co.uk/s?k=hinoki+cutting+board+Shun+Kai+Japanese&tag=adrichops-21
  cta: Check current price
- name: Cutting board stand or rack
  merchant: Amazon UK
  category: Care
  note: Simple airflow solves a lot of board problems. Damp boards stored flat are how sadness grows legs.
...
- src: assets/img/boards-hasegawa-asahi-hinoki.svg
  alt: Board material overview
  caption: 'Three board lanes: synthetic soft, rubber, and hinoki.'
sourceTrail:
- name: Hasegawa Kitchen Wares cutting boards
  url: https://hasegawakagaku.com/products_category/cutting-boards/
  type: Maker
  note: 'Official line overview: wood-core boards, soft surfaces for delicate Japanese knives, harder surfaces for general use.'
- name: Hasegawa Pro-Soft
  url: https://hasegawakagaku.com/products/pro-soft/
  type: Maker
  note: Official description of the soft wood-core board as blade friendly and suitable for sushi and sashimi cutting.
- name: Parker Asahi Cookin Cut rubber board PDF
  url: https://www.parker-asahi.co.jp/pdf/Elastic_Rubber_Chop_Board_en.pdf
  type: Maker
  note: Official material notes on synthetic rubber texture, low water absorption, quick drying and sanitation claims.
- name: Asahi vs Hasegawa boards - Kitchen Knife Forums
  url: https://www.kitchenknifeforums.com/threads/asahi-vs-hasegawa-boards.45898/
  type: Forum
  note: Forum comparison notes on grip, edge friendliness, push cutting and protein prep feel.
- name: Kai Shun Large Hinoki Cutting Board
  url: https://shun.kaiusa.com/large-hinoki-cutting-board.html
  type: Maker
  note: Retailer/manufacturer note describing hinoki as medium-soft wood that gives under the knife.
- name: Hinoki cutting board use guide
  url: https://hinoki-manaita.com/en/use.html
  type: Care reference
  note: Use guidance on wetting the board lightly before cutting, using both sides and washing during raw food prep.
status: Guide
sourceMode: Research-led guide with practical interpretation.
slug: hasegawa-asahi-hinoki-cutting-board-guide
route: /guides/hasegawa-asahi-hinoki-cutting-board-guide/
---
