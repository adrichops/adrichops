...
<meta property="og:image" content="{esc(BASE_URL.rstrip()+image)}">
...
def home(posts):
    ...
    return head('Adrichops — Japanese knives, sharpening and practical buying notes', 'Adrian’s personal knife notebook: reviews, maker spotlights, sharpening, boards, stones and recommendations.', '/') + header('') + f'''<main class="page">
  <section class="hero">
    <div><span class="kicker">Personal knife notebook</span><h1>Adrichops.</h1><p class="lead">Kitchen knives, sharpening, makers and buying notes from Adrian — a former line cook who learned on chipped Shun edges, lived with a Tojiro DP, and came back from Japan with a problem best described as functional-art appreciation.</p></div>
